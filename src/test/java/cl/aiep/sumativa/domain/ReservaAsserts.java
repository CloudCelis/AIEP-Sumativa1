...
public class ReservaAsserts {
    ...
    public static void assertReservaUpdatableFieldsEquals(Reserva expected, Reserva actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getReserva()).as("check reserva").isEqualTo(actual.getReserva()))
    ...
    public static void assertReservaUpdatableRelationshipsEquals(Reserva expected, Reserva actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getPacientes()).as("check pacientes").isEqualTo(actual.getPacientes()))
            .satisfies(e -> assertThat(e.getFkMedico()).as("check fkMedico").isEqualTo(actual.getFkMedico()))
