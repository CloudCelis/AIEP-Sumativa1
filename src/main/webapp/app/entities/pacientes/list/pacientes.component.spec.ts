...
import { sampleWithRequiredData } from '../pacientes.test-samples';
...
describe('Pacientes Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to pacientesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPacientesIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPacientesIdentifier).toHaveBeenCalledWith(entity);
