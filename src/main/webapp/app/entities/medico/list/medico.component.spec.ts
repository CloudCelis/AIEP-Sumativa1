...
import { sampleWithRequiredData } from '../medico.test-samples';
...
describe('Medico Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to medicoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMedicoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMedicoIdentifier).toHaveBeenCalledWith(entity);
