...
/**
 * REST controller for managing {@link cl.aiep.sumativa.domain.Medico}.
 */
@RestController
...
public class MedicoResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Medico>> getAllMedicos(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
