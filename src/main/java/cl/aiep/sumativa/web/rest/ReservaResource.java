...
/**
 * REST controller for managing {@link cl.aiep.sumativa.domain.Reserva}.
 */
@RestController
...
public class ReservaResource {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Reserva> updateReserva(@PathVariable(value = "id", required = false) final Long id, @RequestBody Reserva reserva)
